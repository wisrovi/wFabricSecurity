"""
Slave FastAPI - Recibe imagen (Async)
"""
...
app = FastAPI(title="Slave Image - Async")
...
async def process_image(data: ImageData):
    ...
    resultado = {
        ...
        "format_detected": "png",
        "objects_found": 3,
        "analysis": "Vehículo detectado con confianza 0.95 (async)",
    }

"""
Slave FastAPI - Recibe archivo binario (Síncrono)
"""
...
app = FastAPI(title="Slave Data - Sync")
...
if __name__ == "__main__":
    print("=" * 50)
    print("  SLAVE DATA - Modo Síncrono")
    print("=" * 50)
    uvicorn.run(app, host="127.0.0.1", port=8031, reload=False)
